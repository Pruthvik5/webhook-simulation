...
function order_details() {
    ...
    if (form.url.value == "") {
        ...
        var order_charge_gst_tax = parseFloat(order_charge_cgst_tax + order_charge_sgst_tax + item_1_pc_sgst_tax + item_1_pc_cgst_tax + item_2_pc_sgst_tax + item_2_pc_cgst_tax);
        var order_level_total_tax = parseFloat((order_charge_gst_tax).toFixed(2));
        ...
        var trigger = {
            "customer": {
                ...
                "email": "swiggy_dflt_user@email.com",
                "name": "Swiggy User",
                "phone": "+919999999992"
            },
            "order": {
                "details": {
                    ...
                    "state": "Placed",
                    "taxes": [{
                        "rate": parseFloat(parseFloat(form.a_pc_tax.value).toFixed(1)),
                        "title": "Packaging Charge GST",
                        "value": order_charge_gst_tax
                    }],
