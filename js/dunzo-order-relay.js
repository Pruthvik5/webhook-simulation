...
function order_details() {
    ...
    if (form.url.value == "") {
        ...
        var item_1_taxable_amount = parseFloat((item_1_total).toFixed(2));
        var item_2_taxable_amount = parseFloat((item_2_total).toFixed(2));
        ...
        var order_total = parseFloat(parseFloat(sub_total + total_charge + total_tax).toFixed(2));
        var trigger = {
            "customer": {
                "address": {
                    "city": "Bangalore",
                ...
                "email": "dunzo_dflt_user@email.com",
                "name": "User",
                "phone": "9999999999"
            },
            "order": {
